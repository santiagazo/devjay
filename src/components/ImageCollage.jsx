...
const CollageImage = ({ source, isPortrait = false, alternate = "image", children }) => {
    return (
        <div className="relative group">
            ...
            />
            <div
                className="absolute inset-0 bg-black bg-opacity-80 text-white flex items-end p-4 transition-opacity duration-300 opacity-0 group-hover:opacity-100 overflow-hidden rounded-lg "
            >
                <div className={
                    isPortrait ?
            ...
            images: [
                {
                    ...
                    caption: "After nearly 20 years since our last trip, best friend, Andrew and I went out fishing on the Green River. The trip included big catches, white water rafting, 4x4ing, and fresh fish tacos. A complete success.",
                    isPortrait: false
                },
                {
                    imgSource: FreshFishTacos,
                    alternate: "Fresh fish tacos",
                    caption: "The Green River rainbow and brown trouts are some of the best tasting fish I've ever had. Field dress them, throw them in a cooler, and then butterfly fillet and deep fry them with flour, salt, pepper, and paprika that night. Top with sliced cabbage, fresh pico de gallo and a secret recipe siracha-mayo sauce and queso fresco. 🤤",
                    isPortrait: true
                },
                {
            ...
            images: [
                {
                    ...
                    caption: "Got out early with the family as the season closed out to hike Donut Falls in Big Cottonwood Canyon. The trail was busy, but we hiked back behind the falls and screamed at the top of our lungs for fun. Grabbed donuts on the way home of course.",
                    isPortrait: true
                },
                {
                    imgSource: LaBeaus,
                    alternate: "LaBeaus in Bear Lake, UT",
                    caption: "Lake, Shake, & Paddleboard! Hit Bear Lake with the fam. We don't have a boat so we paddleboarded instead of wakeboarding. Fresh Raspberry Shakes at the famous LaBeau's to completed the day.",
                    isPortrait: false
                },
                {
                    imgSource: MirrorLake,
                    alternate: "Mirror Lake, Uintas, UT",
                    caption: "Snuck out of the tent while the family slept to get some early rays and throw in some lines. Wife followed for a fun morning date. Pic doesn't show that I soaked a leg falling in. 😅",
                    isPortrait: false
                }
            ]
        },
        {
            images: [
                ...
                },
                {
                    ...
                    caption: "Vacation in St. George, UT with the fam. Brought the climbing/rappelling gear and set up rap lines on the face of Dixie Rock. Easy 45 ft. rappel. My awesome kids hit it no problem.",
                    isPortrait: true
                },
                {
                    imgSource: Hawaii,
                    alternate: "Cliff's Edge Below Light House, Honalulu, Hawaii",
                    caption: "Between COVID, a depressed economy, and helping the company I'm at grow, it had been years since Jen & I enjoyed a couples vacation. Finally made it happen in Hawaii. Hiked down to some less known volcanic pools. A fun and long awaited trip.",
                    isPortrait: false
                }
            ]
        },
            ...
            images: [
                {
                    ...
                    caption: "A quick shot before we started Red Reef Trail in St. George, UT. It was a hot day and Red Reef is known for its cool pools slot canyons... but we came late in the season, missed the water, and got lots of sun. Ha. Took great pics though!",
                    isPortrait: false
                },
                {
                    imgSource: StewartFalls,
                    alternate: "Stewart Falls, Sundance Canyon, UT",
                    caption: "On a whim we set out for a hike after work. We showed up on the 3.25 mile round trip hike as the day closed in early fall. We pulled it off just before sunset. Kids did great but one of them is missing from this shot!",
                    isPortrait: false
                },
                {
                    imgSource: PostCNC,
                    alternate: "Selfies Post CNC Plasma Cutting",
                    caption: "While I'm usually writing code, I used to run my own Metal CNC & Fab shop. How I generally look after a day of wrenching, fabing, or grinding. I've always loved working with my hands. Keyboard & code, cars, electronics, metal or machines, I'm a lover of work and fabrication.",
                    isPortrait: true
                }
            ]
        },
        {
            images: [
                ...
                },
                {
                    ...
                    caption: "While I wasn't a drama kid in high school, I've been amazed by the skill of live actors in plays. Newsies was one of the first musicals I watched as a kid and one I totally connected with. Seeing it live as an adult was just as fun.",
                    isPortrait: false
                },
                {
                    imgSource: LakeHavasu,
                    alternate: "Lake Havasu, Havasu Arizona",
                    caption: "Family and Connection - that's what it's all about. Throw some good music, food, weather, and water in the mix and you couldn't ask for a better day.",
                    isPortrait: false
                }
            ]
        },
            ...
            images: [
                {
                    ...
                    caption: "You can't see it here, but we just hiked a 1/2 mile long by 10 feet wide ridge line with a 200 ft drop off on both sides. The address? 666 Badass Lane Sundial Peak. A 10+ mile, unforgiving hike. Paired with my friend in the orange hat, you couldn't have asked for a better adventure.",
                    isPortrait: false
                },
                {
                    imgSource: BlackLightNight,
                    alternate: "Black Light Night Dance Party",
                    caption: "Attending a school event with my kids - Black Light Night! Elementary schools now have raves! 🤣",
                    isPortrait: false
                },
                {
                    imgSource: GreenRiverFirstCatch,
                    alternate: "Green River, Flaming Gorge UT",
                    caption: "The little ones are just as fun as the big ones... when it's your first one of the trip!",
                    isPortrait: true
                }
            ]
        },
        {
            images: [
                ...
                },
                {
                    ...
                    alternate: "Sundial Peak, Cottonwood Canyon UT",
                    caption: "That peak in the background... that's Sundial Peak! A 10+ Mile hike which includes a 200ft drop off ridge that we climbed. See other pics with this stud to learn more!",
                    isPortrait: false
                },
                {
                    imgSource: TempleTrip,
                    alternate: "Orem Temple, Orem UT",
                    caption: "Quick pics after a sesh with my wife, my little bro, and his wife. Family first, it's what fuels the rest!",
                    isPortrait: false
                }
            ]
        },
            ...
            images: [
                {
                    ...
                    caption: "Attended a wedding and got to take pics with the kids after. Planting roots where it matters.",
                    isPortrait: false
                },
                {
                    imgSource: Illuminaria,
                    alternate: "Illuminaria, Gardens, Lehi UT",
                    caption: "Got a chance to take my kids out on a cold night to the local Christmas Luminaria. Hot chocolate, marshmelos, and Christmas lights... and a fire and ice show!",
                    isPortrait: false
                },
                {
                    imgSource: PCC,
                    alternate: "PCC Hawaii",
                    caption: "Taking in my first show at PCC in Hawaii. Probably old news for the wife, but a new experience together. After 16 years, those are harder to come by!",
                    isPortrait: true
                }
            ]
        }
